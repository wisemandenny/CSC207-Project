...
/**
 * This class is used to hold background objects which are used in many other places in the front end.
 * This avoids code duplication and makes it easier to change colors throughout the program.
 */
class Backgrounds {
